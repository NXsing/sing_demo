...
a("Пройти в комнату","goto комната-2")
e()

r("комната-2")
t("Вы находитесь в комнате")
t(", вы в первый раз здесь<br>","ifnot посетил-2")
t(", вы уже были здесь<br>","ifset посетил-2")
a("[открыто] Посмотреть видео на смартфоне ","set посетил-2;next")
e()
